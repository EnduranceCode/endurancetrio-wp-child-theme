...
function endurancetrio_theme_scripts() {
  ...
  wp_enqueue_style('endurancetrio_style', get_stylesheet_directory_uri() . '/css/template.css', array(), 'v0.4.3', 'all');

  wp_register_script('endurancetrio_script', get_stylesheet_directory_uri() . '/js/template.js', array(), 'v0.4.3', true);
